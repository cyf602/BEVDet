...
parser.add_argument('--source-path1', type=str, default='data/nuscenes/bevdetv3-nuscenes_infos_val.pkl', help='pkl1 path')#QAF2d
parser.add_argument('--source-path2', type=str, default='data/nuscenes/nuscenes2d_stream_temporal_infos_val.pkl', help='pkl2 path')#bevdet
