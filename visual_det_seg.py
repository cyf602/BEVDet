...
def render_sample_data(
    ...
    lidar_img,lidar_img_gt = lidiar_render(sample_toekn, pred_data, out_path=out_path)
    ...
    for ind, cam in enumerate(cams):
        ...
        if sensor_modality in ['lidar', 'radar']:
            ...
            # Show boxes.
            if with_anns:
                for box in boxes_gt:#boxes_pred:
...
if __name__ == '__main__':
    ...
    limit=100
    bbox_result_file='test/bevdet-r50-4d-depth-cbgs-detseg/Sun_Nov_17_10_40_36_2024/results_nusc.json'
    savedir=os.path.dirname(bbox_result_file)+'/pts_bbox/plots_2'
